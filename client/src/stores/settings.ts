...
const DEFAULT_SETTINGS: AggregateSettings = {
  ...
  ai: {
    ...
    effectiveFeatureRoutes: {
      'thinking-partner': { provider: 'openai', model: 'gpt-4.1-mini', inherited: true },
      'field-suggestions': { provider: 'openai', model: 'gpt-4.1-mini', inherited: true },
      'health-check': { provider: 'openai', model: 'gpt-4.1-mini', inherited: true },
      'discover-insights': { provider: 'openai', model: 'gpt-4.1-mini', inherited: true },
      default: { provider: 'openai', model: 'gpt-4.1-mini', inherited: true },
    },
    guardrails: {
      featureEnabled: {

    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'After saving the project root, click "Test connection" to check that the path exists and is accessible. Seedbank will create the directory on first graduation if the parent folder exists.' },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'Optional adapters can integrate with a specific local workflow tool or project manager. Each adapter needs a project root configured in Settings → Project Graduation (expand the Advanced section). Custom adapters are not required and do not affect any other Seedbank features.' },

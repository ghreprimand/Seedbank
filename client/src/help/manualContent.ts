    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'When an idea meets readiness criteria for its next stage, Seedbank shows a subtle "Ready for …" nudge near the stage badge. This is informational only — manual stage changes are always available.' },
          { type: 'tip', text: 'Change stage any time from the idea detail stage picker. Promotion nudges are informational only and never block manual stage changes.' },
        ],
      },
      {
        id: 'categories',
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            'Seed → Sprout: The Spark ≥ 40 characters and at least one tag.',
          ...
          { type: 'p', text: 'If all criteria are met, the panel shows a "Ready for [next stage]" banner with one-click promote. Otherwise it shows exactly what is missing.' },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            'Install GitHub CLI (`gh`) on this machine and run `gh auth login`.',
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            'Open an idea with a graduated local project path.',
            'Click Publish to GitHub from the idea detail actions.',

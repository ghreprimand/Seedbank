    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'On any idea detail page, click "Develop with agent". The agent receives the idea as a markdown brief and works in a temporary sandbox. Its transcript streams live in the panel.' },
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', text: 'Agent runs are sandboxed and time-capped.' },
          { type: 'ul', items: [
            'Runs are limited to a per-idea scratch workspace — no access to arbitrary filesystem paths.',
            ...
            'Every proposed file change requires explicit accept/reject.',
          ]},
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            'Tokens are scoped: read:ideas, write:ideas, or ai:suggest.',
          ...
          { type: 'p', text: 'Read-only endpoints at /api/mcp/ideas and /api/mcp/search expose seeds as context for external Claude or Codex sessions. Requires a bearer token with read:ideas scope.' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'When enabled, every backup also writes a full JSON archive to ~/.seedbank/exports/.' },
      ...
      },
      {
        ...
        keywords: ['settings', 'integrations', 'archon', 'scaffold', 'graduation', 'project', 'plugin'],
        blocks: [
          { type: 'p', text: 'Settings → Integrations shows available graduation plugins and lets you configure them.' },
          { type: 'h3', text: 'Archon integration' },
          { type: 'p', text: 'Creates an Archon project folder with context files when you graduate an idea. Requires an Archon workspace path.' },
          { type: 'h3', text: 'Generic scaffold' },
          { type: 'p', text: 'Creates a plain local project directory. Useful without Archon.' },
          { type: 'tip', text: 'Configure integrations here before using the Graduation flow on an idea.' },
        ],
      },
      {
        id: 'settings-about',
    ...
    sections: [
      {
        ...
        blocks: [
          { type: 'p', text: 'Graduation turns a mature seed into a real project scaffold. It runs readiness checks, creates the scaffold via the chosen integration, and advances the idea to Shipped.' },
          ...
          { type: 'ul', items: [
            ...
            'Choose an integration (Archon or generic local scaffold).',
            'Confirm — the scaffold is created and the idea moves to Shipped.',
          ]},
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            'Database: ~/.seedbank/seedbank.db (SQLite).',
            'Backups: ~/.seedbank/backups/',
            'JSON exports: ~/.seedbank/exports/',
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'Restore from a recent backup in ~/.seedbank/backups/. Rename the backup file to seedbank.db and replace the current database.' },
        ],
      },
    ],
  },

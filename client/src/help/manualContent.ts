    ...
    sections: [
      {
        ...
        keywords: ['project', 'draft', 'files', 'spec', 'todo', 'implementation', 'ai', 'model', 'effort', 'download'],
        blocks: [
          { type: 'p', text: 'Project drafting turns the current idea into reviewable starter files such as SPEC.md, IMPLEMENTATION_NOTES.md, RESEARCH_NOTES.md, or TODO.md. It uses the normal AI provider system, so it can run through an API-key provider, Claude account login, Codex account login, a local model, or an OpenAI-compatible endpoint.' },
          ...
          { type: 'h3', text: 'How to draft files' },
          { type: 'ul', items: [
            'Open an idea detail page.',
            'Click Draft project files above the Thinking Partner panel.',
            'Adjust the prompt if you want a specific output set or scope.',
            'Generate the draft and review each file in the preview panel.',
            'Download selected files, or save them into the graduated project path when the idea has one.',
          ]},
          { type: 'h3', text: 'Review-first output' },
          { type: 'p', text: 'Drafting never overwrites canonical idea fields such as pitch, hook, notes, risks, or tech stack. Files are generated as proposed content for review. Only the files you select are downloaded or saved into a graduated project path. Existing project files are not overwritten.' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            ...
            'CLAUDE.md — always. AI context for use with an AI coding session.',
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { type: 'ul', items: [
            ...
            'CLAUDE.md — starter context for an AI coding session.',

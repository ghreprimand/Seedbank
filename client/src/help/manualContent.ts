    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'p', text: 'The Thinking Partner uses whichever AI provider you\'ve set as default in Settings → AI & Agents. Built-in options are OpenAI, Anthropic, and Ollama (local). Support for custom OpenAI-compatible endpoints (OpenRouter, LM Studio, vLLM, and similar) is planned.' },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        keywords: ['settings', 'ai', 'agents', 'provider', 'openai', 'anthropic', 'ollama', 'custom', 'openrouter', 'api key', 'model', 'budget', 'token', 'link', 'claude code', 'codex'],
        blocks: [
          ...
          { type: 'ul', items: [
            ...
            'Custom OpenAI-compatible providers (planned) — configure any endpoint that accepts OpenAI-format requests, such as OpenRouter, LM Studio, or a local gateway.',
          ]},
          ...
          { type: 'p', text: 'Set a daily token limit. The limit is enforced server-side; requests that exceed it return an error. Usage is tracked in last-24h and last-7d readouts. Setting 0 disables the limit.' },
          { type: 'h3', text: 'Agents' },

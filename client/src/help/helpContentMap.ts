...
export const HELP_CONTENT_MAP: Record<string, HelpEntry> = {
  ...
  'settings-ai-services': {
    title: 'AI Services',
    body: 'Top-level AI setup area. Configure provider cards here, then route features in Feature Defaults.',
    details: 'Each card is an actual backend route. Use the ⋯ menu for Set as default and, on Claude/Codex cards, switching between subscription/account login and API-key paths.',
    manualSection: 'provider-chooser',
  },
  'settings-ai-claude-service': {
    title: 'Claude Service',
    body: 'Claude-family routing: Claude subscription login by default, or Anthropic API key from the card menu.',
    details: 'Use the card\'s ⋯ menu for Set as default, Use API key instead / Use subscription instead, and sign-out actions when available.',
    manualSection: 'settings-ai',
  },
  'settings-ai-codex-service': {
    title: 'Codex / OpenAI Service',
    body: 'OpenAI-family routing: Codex login or direct OpenAI API key.',
    details: 'Use the card\'s ⋯ menu to switch between Codex login and OpenAI API key. Codex login is local app-server auth, separate from external cloud routers.',
    manualSection: 'settings-ai',
  },
  'settings-ai-local-models': {
    title: 'Local Models',
    body: 'Configure local inference methods such as Ollama or local OpenAI-compatible servers.',
    details: 'Choose the local server type for the main card, or expand "+ Add another local instance" for separate labels, URLs, models, and statuses.',
    manualSection: 'settings-ai',
  },
  'settings-ai-external-cloud': {
    ...
    details: 'For OpenRouter, select the preset, confirm URL, enter model and API key, save, then Test or List models. Requests routed here leave your machine.',
    manualSection: 'settings-ai',
  },
  'settings-ai-provider-card': {
    title: 'Provider Card',
    body: 'This card configures one concrete provider instance.',
    details: 'Expand for model/key/URL fields. The status is shown as a colored dot plus label; the ⋯ menu holds Set as default and account/path actions.',
    manualSection: 'settings-ai',
  },
  'settings-ai-add-local-instance': {
    ...
    details: 'Expand "+ Add another local instance" when you run multiple local servers so each can be routed independently in Feature Defaults.',
    manualSection: 'settings-ai',
  },
  'settings-ai-add-external-instance': {
    ...
    details: 'Expand "+ Add another cloud provider" for extra OpenRouter/Groq/Mistral/Together/Fireworks/custom HTTPS accounts, experiments, or model-access policies.',
    manualSection: 'settings-ai',
  },

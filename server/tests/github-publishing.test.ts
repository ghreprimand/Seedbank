...
test('gitCliSearchPaths includes standard Windows Git install directories before Path', () => {
  ...
  assert.deepEqual(gitCliSearchPaths(env, 'win32'), [
    ...
    path.join('C:\\Program Files', 'PortableGit', 'cmd'),
    path.join('C:\\Program Files', 'PortableGit', 'bin'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Programs', 'Git', 'cmd'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Programs', 'Git', 'bin'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Programs', 'PortableGit', 'cmd'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Programs', 'PortableGit', 'bin'),
    path.join('C:\\Users\\octo', 'Git', 'cmd'),
    path.join('C:\\Users\\octo', 'Git', 'bin'),
    path.join('C:\\Users\\octo', 'PortableGit', 'cmd'),
    path.join('C:\\Users\\octo', 'PortableGit', 'bin'),
    path.join('C:\\Users\\octo', 'scoop', 'shims'),
    path.join('C:\\Users\\octo', 'scoop', 'apps', 'git', 'current', 'cmd'),
    path.join('C:\\Users\\octo', 'scoop', 'apps', 'git', 'current', 'bin'),
    path.join('C:\\ProgramData', 'chocolatey', 'bin'),
    path.join('C:\\ProgramData\\chocolatey', 'bin'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'GitHubDesktop', 'bin'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Microsoft', 'WinGet', 'Links'),
    path.join('C:\\Users\\octo\\AppData\\Local', 'Microsoft', 'WindowsApps'),
    path.join('C:\\Users\\octo\\AppData\\Roaming', 'npm'),
    'C:\\Tools',
    'C:\\Windows\\System32',
  ]);
});

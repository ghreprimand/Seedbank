...
export const OPENAI_COMPATIBLE_PRESETS: Record<AiOpenAICompatiblePresetId, AiProviderDescriptor> = {
  ...
  together: compatiblePreset('together', 'Together', 'meta-llama/Llama-3.3-70B-Instruct-Turbo', 'https://api.together.xyz/v1', true, false),
  fireworks: compatiblePreset('fireworks', 'Fireworks', 'accounts/fireworks/models/llama-v3p1-70b-instruct', 'https://api.fireworks.ai/inference/v1', true, false),
...
export const AI_PROVIDER_INSTANCE_REGISTRY: Record<AiProviderInstanceId, AiProviderInstanceRegistryEntry> = {
  'claude-api': {
    id: 'claude-api',
    provider: 'anthropic',
    family: 'api',
    ...
    supportsUsageAuditMetadata: true,
  },
  'claude-account': {
    id: 'claude-account',
    provider: 'claude-account',
    ...
    connectionMode: 'account-login',
    dataResidency: 'cloud',
    requiredFields: ['accountLogin', 'runtime', 'model'],
    supportsModelDiscovery: true,
    supportsHealthCheck: true,
    supportsPreflight: true,
    supportsUsageAuditMetadata: true,
  ...
  'local-openai-compatible': {
    ...
    connectionMode: 'openai-compatible-local',
    dataResidency: 'local',
    requiredFields: ['preset', 'baseUrl', 'model'],
    supportsModelDiscovery: true,
    supportsHealthCheck: true,
    supportsPreflight: true,
    supportsUsageAuditMetadata: true,
  ...
  'cloud-openai-compatible': {
    ...
    connectionMode: 'openai-compatible-cloud',
    dataResidency: 'cloud',
    requiredFields: ['preset', 'baseUrl', 'apiKey', 'model'],
    supportsModelDiscovery: true,
    supportsHealthCheck: true,
    supportsPreflight: true,
    supportsUsageAuditMetadata: true,

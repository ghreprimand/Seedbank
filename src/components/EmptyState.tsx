  ...
  if (isFiltered) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
        <div className="w-14 h-14 rounded-full bg-frost-50 border border-frost-100 flex items-center justify-center mb-4">
        ...
        {onClearFilters && (
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-sage-700 bg-sage-50 hover:bg-sage-100
                       border border-sage-200 rounded-pill transition-all duration-200"
          >
            Clear all filters
          </button>
        )}
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
      <div className="w-16 h-16 rounded-full bg-sage-50 border border-sage-100 flex items-center justify-center mb-5">
        <Sprout className="w-8 h-8 text-sage-400" />
      </div>
      ...
      <div className="flex flex-col items-center gap-3">
        {onPlantSeed && (
          <button
            ...
            className="bg-clay-500 hover:bg-clay-600 active:bg-clay-700 text-paper px-5 py-2.5
                       rounded-pill text-sm font-medium transition-all duration-200
                       flex items-center gap-2 shadow-card hover:shadow-card-hover active:scale-[0.98]"
          >
        ...
        {onSeedExamples && (
          <button
            ...
            className="text-xs text-ink-300 hover:text-sage-600 transition-colors"
          >
